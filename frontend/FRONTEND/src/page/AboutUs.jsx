        ...
        <div id="abouttopcontent" className="px-[10px] py-[60px]">
          <main data-aos="fade-up">
            <div  className="content">
              ...
              Atorax is your trusted partner for career growth, offering advanced tech courses designed to prepare you for the fast-paced job market. We focus on delivering industry-relevant skills through expert guidance, ensuring that you gain both theoretical knowledge and practical experience. Each course is backed by hands-on projects, allowing you to work on real-world challenges that employers value. Whether you're starting your career or looking to upskill, our programs in Web Development, Data Science, and Digital Marketing are tailored to help you succeed. Join Atorax today and take the next step toward achieving your career goals.
              </p>
            </div>
        ...
        <section className="px-[10px] py-[60px]">
          <div className=" mx-auto">
            ...
            <div className="mx-auto max-w-3xl text-lg text-center flex flex-col gap-10 tracking-tighter">
              <p data-aos="fade-up">
                Founded in 2024, Atorax emerged with a vision to
              ...
              <p data-aos="fade-up">
                Today, Atorax continues to innovate, expanding our
