        ...
        <div className="p-1 border-r-2 border-[#0808083a]">
          {users.length > 0 ? (
            users.map((user, index) => (
              <div key={index} className="space-y-6 text-center p-3 bg-gradient-to-r from-white to-purple-500 text-transparent bg-clip-text">
                ...
                <h2 className="text-xl font-semibold">
                  <span className="font-bold">Atorax Coins: </span>
                  {user.totalCoins}
                </h2>
              </div>
            ))
          ...
          <div className="text-center mt-5 space-y-4">
            ...
            <div className=" flex justify-center gap-6">
              <a
                target="_blank"
                href="https://www.facebook.com/people/Atorax-Solutions/61563953173071/"
              ...
              <a
                target="_blank"
                href="https://www.youtube.com/@AtoraxSolutions"
              ...
              <a
                target="_blank"
                href="https://www.instagram.com/atorax"
              ...
              <a
                target="_blank"
                href="https://www.linkedin.com/company/atorax/"
