    ...
    <div className="z-[1000] fixed top-0 left-0 w-full h-[70px] bg-[#05050A]/80 backdrop-blur-md border-b border-white/10 flex items-center px-6 justify-between">
      ...
      <div className="fixed top-[70px] left-0 w-[265px] h-[calc(100vh-70px)] bg-[#0A0A0F]/95 backdrop-blur-2xl border-r border-white/5 overflow-y-auto custom-scrollbar pb-10">
        ...
        <div className="flex flex-col p-4 gap-1 relative z-10">
          ...
          {[
            { to: "/AddAdvCourse", icon: "fa-plus-circle", text: "Create Adv Course", color: "text-blue-400" },
            { to: "/AddAdvModule", icon: "fa-list", text: "Adv Course List", color: "text-blue-400" },
            { to: "/AdvExercisePage", icon: "fa-code", text: "Adv Exercise Builder", color: "text-indigo-400" },
            { to: "/CreateAdvOperation", icon: "fa-briefcase", text: "Create ADV Operation", color: "text-blue-400" },
            { to: "/CreateAdvTeam", icon: "fa-users", text: "Create Adv Team", color: "text-purple-400" },
            { to: "/AdvOnBoardingDetails", icon: "fa-graduation-cap", text: "ADV Onboarding", color: "text-emerald-400" },
            { to: "/AdvBooked", icon: "fa-bookmark", text: "ADV Booked", color: "text-blue-400" },
            { to: "/AdvFullPaid", icon: "fa-check-square", text: "ADV FullPaid", color: "text-emerald-400" },
            { to: "/AdvDefault", icon: "fa-times-circle", text: "ADV Default", color: "text-red-400" },
            { to: "/AdvanceQueries", icon: "fa-question-circle", text: "Adv Course Queries", color: "text-yellow-400" },
            { to: "/AdvLeadManagement", icon: "fa-users", text: "ADV Lead Mgmt", color: "text-purple-400" },
            { to: "/AdvFormLeads", icon: "fa-wpforms", text: "Adv Form Leads", color: "text-blue-400" },
            { to: "/AdvTeamDetail", icon: "fa-users", text: "ADV Team Details", color: "text-purple-400" },
            { to: "/AdvUserManagement", icon: "fa-users-cog", text: "ADV User Mgmt", color: "text-indigo-400" },
            { to: "/AdminAnalytics", icon: "fa-area-chart", text: "ADV Analytics", color: "text-emerald-400" },
            { to: "/BulkImport", icon: "fa-upload", text: "Bulk Import Leads", color: "text-blue-400" },
            { to: "/AdvRevenueSheet", icon: "fa-line-chart", text: "ADV Revenue Sheet", color: "text-emerald-400" },
            { to: "/AdvProjectPage", icon: "fa-tasks", text: "Adv Project Mgmt", color: "text-indigo-400" },
