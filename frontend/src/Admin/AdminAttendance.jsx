          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
            ...
            <form onSubmit={handleAddMember} className="p-6 space-y-4">
              ...
              <div>
                ...
                <input type="email" placeholder="john@Aiiens Campus.com" value={newMember.email} onChange={e => setNewMember({...newMember, email: e.target.value})} required className="w-full px-4 py-2.5 bg-white border border-slate-300 rounded-lg text-slate-800 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/40 focus:border-indigo-500" />
              </div>
              <div>
