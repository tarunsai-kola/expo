      ...
      <div className="max-w-[1280px] mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-4">
            <Link to="/" className="inline-flex items-center gap-3 mb-6 group">
              <div className="bg-white/5 p-2 rounded-xl border border-white/10 group-hover:border-white/20 transition-colors">
                <img src={logo} alt="ΣxpoGraph" className="h-8 w-auto object-contain" />
              </div>
              <span className="text-2xl font-black tracking-widest text-white">ΣXPOGRAPH</span>
            </Link>
            <p className="text-gray-400 text-sm leading-relaxed mb-8 max-w-sm">
              Empowering the next generation of engineers with structured learning, expert mentorship, and measured career outcomes. Build the future with ΣxpoGraph.
            </p>
          ...
          <div className="lg:col-span-3 lg:col-start-10">
            ...
            <div className="space-y-5">
              <a href="mailto:support@ΣxpoGraph.com" className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <div className="text-gray-300 text-sm group-hover:text-white transition-colors">support@ΣxpoGraph.com</div>
                </div>
              </a>
              ...
              <a href="tel:+917829104024" className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <div className="text-gray-300 text-sm group-hover:text-white transition-colors">+91 9014110638</div>
                </div>
              </a>
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <div className="text-gray-300 text-sm group-hover:text-white transition-colors">Vizianagaram, AP, India</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} ΣxpoGraph. All rights reserved.
          </p>
