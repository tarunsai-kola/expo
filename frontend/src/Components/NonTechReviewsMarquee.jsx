...
const allReviews = [
  ...
  { name: "Manish Tiwari", prev: "MBA", role: "Product Engineer", quote: "I realized I wanted to build products, not just manage them. The transition was tough but ΣxpoGraph made it entirely worth it." },
  ...
  { name: "Riya Das", prev: "HR Executive", role: "Full Stack Dev", quote: "I hired developers and realized I wanted to be one. ΣxpoGraph gave me the exact roadmap I needed to make the switch." },
