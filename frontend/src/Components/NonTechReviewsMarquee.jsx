...
const allReviews = [
  ...
  { name: "Manish Tiwari", prev: "MBA", role: "Product Engineer", quote: "I realized I wanted to build products, not just manage them. The transition was tough but Aiiens Campus made it entirely worth it." },
  ...
  { name: "Riya Das", prev: "HR Executive", role: "Full Stack Dev", quote: "I hired developers and realized I wanted to be one. Aiiens Campus gave me the exact roadmap I needed to make the switch." },
