        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-sm text-gray-600">
              © 2026 Aiiens Campus Events. All Rights Reserved.
            </p>
        ...
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="sticky top-0 bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-4 rounded-t-2xl flex items-center justify-between">
              <h2 className="text-2xl font-bold">🏆 Aiiens Campus Coins Rewards</h2>
              <button
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="bg-blue-50 border-l-4 border-blue-600 p-4 rounded-r-lg">
                <p className="text-gray-800">
                  <strong className="text-blue-700">Collect 5000 Aiiens Campus Coins</strong> to unlock exclusive offers and rewards!
                </p>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="border border-gray-200 rounded-lg p-4 hover:border-blue-300 hover:shadow-md transition-all">
                    <h4 className="font-semibold text-gray-900 mb-1">Aiiens Campus Self-Learning Program</h4>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-5">
                ...
                <p className="text-gray-600 mb-3">Contact us to convert your Aiiens Campus Coins into any of the offers above.</p>
                <div className="flex items-center space-x-2 text-blue-600">
                  <i className="fa fa-envelope"></i>
                  <a
                    href="mailto:support@Aiiens Campus.com"
                    className="font-semibold hover:underline"
                  >
                    support@Aiiens Campus.com
                  </a>
                </div>
              </div>
