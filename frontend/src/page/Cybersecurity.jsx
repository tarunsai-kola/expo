...
const Tag = ({ children }) => (
  <span style={{ display: "inline-block", background: "rgba(99,102,241,0.15)", color: "#e11d48", fontWeight: 700, fontSize: "11px", textTransform: "uppercase", letterSpacing: "1.5px", padding: "6px 16px", borderRadius: "999px", marginBottom: "20px" }}>{children}</span>
);
    ...
    <div className="sd-bg">
      ...
      <section id="overview" className="relative min-h-[100vh] flex flex-col items-center justify-center pt-32 pb-24 px-6 overflow-hidden bg-[#020408]">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div 
            className="absolute top-[10%] left-[20%] w-[500px] h-[500px] bg-[#e11d48]/20 blur-[130px] rounded-full pointer-events-none mix-blend-screen animate-pulse" 
          />
          <div 
        ...
        <div className="relative z-10 w-full max-w-[1200px] mx-auto flex flex-col items-center text-center mt-[-8vh]">
          ...
          >
            ...
            <span className="relative inline-block mt-2">
              <span className="absolute inset-0 bg-[#e11d48]/30 blur-[80px] animate-pulse"></span>
              <span className="relative text-transparent bg-clip-text bg-gradient-to-r from-[#a5b4fc] via-[#e11d48] to-[#3730a3] drop-shadow-[0_0_60px_rgba(99,102,241,0.8)]">
                The Future
              </span>
            </span>
          </h1>
          ...
          <div className="flex flex-col items-center gap-12 px-4">
            <div className="flex flex-wrap justify-center gap-6">
              ...
              <div className="relative group rounded-full p-[2px] overflow-hidden shadow-[0_0_40px_rgba(99,102,241,0.4)] hover:shadow-[0_0_60px_rgba(99,102,241,0.7)] transition-shadow duration-500">
                ...
                <div className="absolute inset-0 bg-[#e11d48]/20 backdrop-blur-md" />
                  ...
                  >
                    <div className="p-6">
                      <div className="flex justify-between items-center mb-3">
                        <span className="bg-[#e11d48] text-white text-[11px] font-bold px-3 py-1 rounded">
                          {path.exp}
                        </span>
                        <ChevronDown
                          size={18}
          ...
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-10">
            {toolsList.map((tool, i) => (
              ...
              >
                ...
                <span className="text-[10px] font-bold text-gray-400 tracking-widest text-center leading-tight uppercase group-hover:text-[#e11d48] transition-colors">
                  {tool.name}
                </span>
              </div>
            ))}
      ...
      <section id="projects" className="py-24 px-6 bg-[#050505] border-t border-white/5">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {capstoneProjects.map((project, i) => (
              ...
              >
                 ...
                 <div className="relative z-10 flex flex-col h-full">
                    <div className="flex justify-between items-start mb-8">
                       <div className="w-14 h-14 rounded-2xl flex items-center justify-center bg-zinc-900 border border-white/10 text-white shadow-[0_0_20px_rgba(255,255,255,0.05)] group-hover:scale-110 transition-transform duration-500">
                          {React.createElement(project.icon, {
                            size: 24,
                            className: "text-gray-400 group-hover:text-[#e11d48] transition-colors duration-500",
                            strokeWidth: 1.5,
                          })}
                       </div>
                    ...
                    <h3 className="text-2xl font-bold text-white mb-4 leading-tight group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-[#e11d48] transition-colors">
                       {project.title}
                    </h3>
            ...
            {/* 6th card: Clean CTA */}
            <div className="bg-gradient-to-br from-[#e11d48]/5 to-transparent border border-white/10 rounded-3xl p-8 flex flex-col items-center justify-center text-center transition-all duration-500 hover:bg-[#e11d48]/10">
              <div className="w-16 h-16 bg-[#e11d48]/10 rounded-full flex items-center justify-center mb-6 border border-[#e11d48]/30">
                <Layers size={28} className="text-[#e11d48]" />
              </div>
              ...
              <button
                onClick={() => setShowPopup(true)}
                className="bg-[#e11d48] hover:bg-[#4f46e5] text-white font-bold py-3.5 px-8 rounded-full transition-all duration-300 flex items-center gap-2 shadow-[0_4px_14px_rgba(99,102,241,0.4)] hover:shadow-[0_6px_20px_rgba(99,102,241,0.6)] hover:-translate-y-0.5"
              >
