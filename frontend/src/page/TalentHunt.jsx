...
const TalentHunt = () => {
  ...
  return (
    <div id="talenthunt" className="talent-events">
      <Helmet>
        <title>Aiiens Campus Events | Discover Top Tech Talent</title>
        <meta name="description" content="Participate in Aiiens Campus Talent Hunt events and showcase your skills." />
      </Helmet>
      ...
      <main className="events-page-shell">
        <section className="events-hero">
          ...
          <div className="events-hero-visual">
            <img src={leadEvent?.image || fallbackEventImage} alt={leadEvent?.title || "Featured Aiiens Campus event"} />
