...
export const allMentorshipData = {
  ...
  'artificial-intelligence': {
    ...
    studentReviews: [
      ...
      { name: 'Sahad K', text: "Got placement at Wipro through Aiiens Campus support team. Grateful to mentors and counsellor support.", detail: 'Thanks to the Aiiens Campus team.' },
  ...
  'machine-learning': {
    ...
    studentReviews: [
      ...
      { name: 'Tejas Kolekar', text: 'Thrilled to share my enriching experience from the ML internship with Aiiens Campus. This 3-month program was an incredible opportunity to deepen knowledge and skills in ML.', detail: 'Great mentorship and real-world projects.' },
      { name: 'Pranali Shinde', text: 'Excited to share that I\'ve completed a Data Science course from Aiiens Campus! Amazing journey diving into data visualization, EDA, and machine learning.', detail: 'Gained valuable skills applicable to real-world projects.' },
      { name: 'Sunil Kumar', text: 'Outstanding experience in ML program at Aiiens Campus; learned a lot of new industrial things and practical skills.', detail: 'Strong recommendation for ML enthusiasts.' }
    ],
    certifications: [
  ...
  'cyber-security': {
    ...
    studentReviews: [
      ...
      { name: 'Sahad K', text: 'I realised Aiiens Campus solutions is the best company ever for training and internship provider. I learned a lot of new industrial things.', detail: 'Strong support from mentors and counsellors.' },
  ...
  'data-science': {
    ...
    studentReviews: [
      ...
      { name: 'Rajendra Prasad', text: 'I researched and found the correct certificate on Linkedin and scan that and found it 100% genuine and verified successfully. Aiiens Campus company is perfect with quality training and real world projects.', detail: 'Strong recommendation.' },
      { name: 'Sahad K', text: 'I got placement at Wipro through Aiiens Campus support team. I am really grateful that I got to learn from Al Mentor Ashish sir and support from my counsellor was really helpful.', detail: 'Excellent mentor support.' },
      { name: 'Sunil Kumar', text: 'I have enrolled for Data Science program at Aiiens Campus solutions and my experience is outstanding. Perfect for quality training and real world projects.', detail: 'Highly valuable experience.' },
      { name: 'Shubham Rai', text: 'Aiiens Campus Group is truly doing a remarkable job by creating learning spaces that are not only informative but also inspiring.', detail: 'Great for career growth.' },
  ...
  'data-analytics': {
    ...
    studentReviews: [
      ...
      { name: 'Sahad K', text: 'I realised Aiiens Campus solutions is the best company ever for training and internship provider. I learned a lot of new industrial things.', detail: 'Excellent mentor support.' },
      { name: 'Sunil Kumar', text: 'I have enrolled for Data Science program at Aiiens Campus solutions and my experience is outstanding. Perfect for quality training and real world projects.', detail: 'Highly valuable experience.' },
      { name: 'Shubham Rai', text: 'Aiiens Campus Group is truly doing a remarkable job by creating learning spaces that are not only informative but also inspiring.', detail: 'Great for career growth.' },
  ...
  'ui-ux-design': {
    ...
    studentReviews: [
      ...
      { name: 'Sahad K', text: 'I realised Aiiens Campus solutions is the best company ever for training and internship provider. I learned a lot of new industrial things.', detail: 'Excellent mentor support.' },
      { name: 'Sunil Kumar', text: 'I have enrolled for UI/UX Design program at Aiiens Campus solutions and my experience is outstanding. Perfect for quality training and real world projects.', detail: 'Highly valuable experience.' },
      { name: 'Shubham Rai', text: 'Aiiens Campus Group is truly doing a remarkable job by creating learning spaces that are not only informative but also inspiring.', detail: 'Great for career growth.' },
      { name: 'Tejas Kolekar', text: 'Aiiens Campuss UI/UX Design program was a fantastic learning experience. The course covered essential design tools like Figma, Adobe XD, and UX principles, providing a strong foundation for building user-centered products.', detail: 'Highly recommended.' }
    ],
    certifications: [
      'Training Completion Certificate validating the skills you acquired',
      'Internship Completion certificate certified by Adobe',
  ...
  'devops': {
    ...
    studentReviews: [
      ...
      { name: 'Rajendra Prasad', text: 'I researched and found the correct certificate on Linkedin and scanned that and found it 100% genuine and verified successfully.', detail: 'Strong recommendation.' },
      { name: 'Sahad K', text: 'I realised Aiiens Campus solutions is the best company ever for training and internship provider. I learned a lot of new industrial things.', detail: 'Excellent mentor support.' },
      { name: 'Sunil Kumar', text: 'I got placement at Wipro through Aiiens Campus support team. I am really grateful that I got to learn from mentor Aashish sir and support from my counsellor was really helpful.', detail: 'Highly valuable experience.' },
      { name: 'Shubham Rai', text: 'Aiiens Campus Group is truly doing a remarkable job by creating learning spaces that are not only informative but also inspiring.', detail: 'Great for career growth.' }
    ],
    certifications: [
      'Training Completion Certificate validating the skills you acquired',
