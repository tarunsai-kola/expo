...
export const androidAppData = {
  ...
  studentReviews: [
    {
      name: "Paidi Venkata",
      text: "Certificate of Training Completion from Aiiens Campus Solutions in the field of Android App Development. Incredible hands-on learning experience with expert mentors.",
      detail: "#Aiiens Campus #android #app #development #androidstudio"
    },
    {
      name: "Ramshad K",
    ...
    {
      name: "Sahad K",
      text: "Got placement at Wipro through Aiiens Campus support team. I am really grateful that I got to learn from excellent mentors. Support from my counsellor was really helpful.",
      detail: "All thanks to Bhoomika mam and the entire Aiiens Campus team."
    },
    {
      name: "Aman Nema",
      text: "Aiiens Campus's training program was fantastic. The course covered essential Android technologies, practical projects, and expert guidance from mentors.",
