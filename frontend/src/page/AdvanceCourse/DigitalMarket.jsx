...
import posterImage from "../../../Aiiens Campus/images/poster/digitalmarketing.png";
...
import dmBrochure from "../../../Aiiens Campus/Digital Marketing Advanced Program.pdf";
const heroStats = [
        ...
        <div className="shell">
           <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(320px, 1fr))', gap:'80px', alignItems:'start'}}>
              ...
              <div className="p-card" style={{padding:'32px', maxWidth:'520px'}}>
                 <div style={{marginBottom:'24px'}}><h3 style={{fontSize:'20px', fontWeight:800, marginBottom:'4px'}}>Request a Callback</h3><p style={{fontSize:'13px', color:'var(--dm-text-dim)'}}>Connect with the AIIENS CAMPUS team today.</p></div>
