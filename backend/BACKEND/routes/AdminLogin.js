...
router.post('/sendmailtooperation', async (req, res) => {
  ...
  const content = `
      ...
      <div style="text-align: center; margin: 35px 0;">
          <a href="https://www.Aiiens Campus.com/operationLogin" target="_blank" class="cta-button">Access Your Portal</a>
      </div>
...
router.post('/sendmailtobda', async (req, res) => {
  ...
  const content = `
      ...
      <div style="text-align: center; margin: 35px 0;">
          <a href="https://www.Aiiens Campus.com/teamlogin" target="_blank" class="cta-button">Access Your Portal</a>
      </div>
...
router.post('/sendmailtoadvteam', async (req, res) => {
  ...
  const content = `
      ...
      <div style="text-align: center; margin: 35px 0;">
          <a href="https://www.Aiiens Campus.com/advteamlogin" target="_blank" class="cta-button">Access Your Portal</a>
      </div>
...
router.post('/sendmailtohr', async (req, res) => {
  ...
  const content = `
      ...
      <div style="text-align: center; margin: 35px 0;">
          <a href="https://www.Aiiens Campus.com/hrlogin" target="_blank" class="cta-button">Access Your Portal</a>
      </div>
...
router.post("/sendmailtoplacementcoordinator", async (req, res) => {
  ...
  const content = `
      ...
      <div style="text-align: center; margin: 35px 0;">
          <a href="https://www.Aiiens Campus.com/pclogin" target="_blank" class="cta-button">Access Your Portal</a>
      </div>
